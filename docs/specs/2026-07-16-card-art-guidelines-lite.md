...
ディアボロ、紐、スティック、人物の3D方向は、カードの画風より先に [ディアボロ画像生成・物理／形状制約](../../../../knowledge/character-consistency-refs/diabolo-physics-constraints.md) を適用する。構図やポップさが良くても、同仕様のハード失格に1つでも該当する画像は採用しない。
