(function (global) {
  ...
  DT.DATA = {
    ...
    // ※命名について（2026-08-29 本人判断）: 表示名を架空名へ変えたのは「ジャグリング全国大会」(旧JJF)だけ。
    //   OIDC・AJDC・静岡DC はこのままでよい、と確認済み。表記を揃える目的で改称しないこと。
    CONTESTS: [
    ...
    // ジャグリング全国大会(ディアボロ): 毎年10月開催・9月予選。大会扱い。
    // 表示名は「ジャグリング全国大会」。データキー JJF と内部ID 'jjf' はセーブ互換のため据え置き。
